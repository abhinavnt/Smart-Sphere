...
form.addEventListener('submit', function (event) {
    ...
    const passwordErrorVisible = document.getElementById('passwordError').style.display !== 'none';
    const confirmPasswordErrorVisible = document.getElementById('confirmPasswordError').style.display !== 'none';

    // If no errors are visible, submit the form
    if (!emailErrorVisible && !passwordErrorVisible && !confirmPasswordErrorVisible) {
